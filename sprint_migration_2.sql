-- ============================================================
-- MIGRATION 2: Friendships RLS + DM RLS + Relationship Status
-- Execute no Supabase SQL Editor
-- ============================================================

-- 1. Status de relacionamento nos personagens
...
-- ============================================================
-- 2. RLS da tabela friendships
-- (Corrige: botão Adicionar Amigo não funcionava)
-- ============================================================
...
-- ============================================================
-- 3. RLS da tabela dm_messages
-- (Corrige: envio de DM estava bloqueado)
-- ============================================================
...
SELECT 'characters.relationship_status' AS verificacao, COUNT(*) > 0 AS ok
  ...
  WHERE table_name = 'characters' AND column_name = 'relationship_status'
UNION ALL
SELECT 'friendships RLS', rowsecurity AS ok FROM pg_tables WHERE tablename = 'friendships'
UNION ALL
SELECT 'dm_messages RLS', rowsecurity AS ok FROM pg_tables WHERE tablename = 'dm_messages';
