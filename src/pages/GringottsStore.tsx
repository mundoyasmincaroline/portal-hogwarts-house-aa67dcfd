...
const GALEON_PACKAGES = [
  { id: "bolsinha",  name: "Bolsinha de Galeões",     galeons: 100,  price_brl: 4.90,  icon: "💰", image_url: "https://i.pinimg.com/736x/8f/7d/5a/8f7d5a5700810488663806954848912.jpg", color: "from-amber-800/40 to-amber-900/40", border: "border-amber-600/40", glow: "group-hover:shadow-[0_0_20px_rgba(217,119,6,0.3)]" },
  { id: "saco",      name: "Saco de Galeões",          galeons: 300,  price_brl: 12.90, icon: "🪙", image_url: "https://i.pinimg.com/736x/8f/7d/5a/8f7d5a5700810488663806954848912.jpg", color: "from-amber-700/50 to-yellow-800/40", border: "border-yellow-500/50", glow: "group-hover:shadow-[0_0_25px_rgba(234,179,8,0.4)]", badge: "Mais Popular" },
  { id: "starter",   name: "Pacote do Fundador",      galeons: 2000, price_brl: 47.90, icon: "✨", image_url: "https://i.pinimg.com/736x/8f/7d/5a/8f7d5a5700810488663806954848912.jpg", color: "from-purple-600/50 to-amber-600/50", border: "border-purple-400/70", glow: "group-hover:shadow-[0_0_40px_rgba(168,85,247,0.6)]", badge: "OFERTA ÚNICA" },
  { id: "tesouro",   name: "Tesouro de Gringotts",     galeons: 1500, price_brl: 44.90, icon: "👑", image_url: "https://i.pinimg.com/736x/8f/7d/5a/8f7d5a5700810488663806954848912.jpg", color: "from-yellow-500/60 to-amber-600/50", border: "border-yellow-400/70", glow: "group-hover:shadow-[0_0_35px_rgba(250,204,21,0.6)]", badge: "Melhor Valor" },
  { id: "cofre",     name: "Cofre Lendário",           galeons: 4000, price_brl: 99.90, icon: "🏆", image_url: "https://i.pinimg.com/736x/8f/7d/5a/8f7d5a5700810488663806954848912.jpg", color: "from-yellow-400/70 to-amber-500/60", border: "border-yellow-300/80", glow: "group-hover:shadow-[0_0_45px_rgba(253,224,71,0.7)]", badge: "Lendário" },
];

const MONSTER_QUALITY_ITEMS: StoreItem[] = [
  // WANDS
  { id: "mq_wand_elder", name: "Varinha das Varinhas", category: "wand", price_galeons: 5000, image_url: "https://i.pinimg.com/736x/8f/7d/5a/8f7d5a5700810488663806954848912.jpg", rarity: "legendary", is_featured: true, description: "A varinha mais poderosa já fabricada, feita de sabugueiro e núcleo de pelo de testrálio." },
  { id: "mq_wand_ebony", name: "Varinha de Ébano", category: "wand", price_galeons: 2500, image_url: "https://i.pinimg.com/736x/9e/7b/d8/9e7bd89e7b6d19335f606e788c0a3794.jpg", rarity: "rare", is_featured: false, description: "Ébano é uma madeira preta e impressionante, com um brilho quase metálico." },
  { id: "mq_wand_holly", name: "Varinha de Azevinho", category: "wand", price_galeons: 1200, image_url: "https://i.pinimg.com/736x/21/2e/4d/212e4d898495f3209867938363784912.jpg", rarity: "uncommon", is_featured: false, description: "Uma das madeiras de varinha mais raras e protetoras." },
  
  // CLOTHING
  { id: "mq_cloth_founder", name: "Robe Azul-Safira", category: "clothing", price_galeons: 3500, image_url: "https://i.pinimg.com/736x/f4/62/7b/f4627b08499298491295e86d26798835.jpg", rarity: "legendary", is_featured: true, description: "Robe cerimonial usado pelos antigos fundadores, com bordados de ouro puro." },
  { id: "mq_cloth_crimson", name: "Manto Carmesim", category: "clothing", price_galeons: 2800, image_url: "https://i.pinimg.com/736x/d8/9e/7b/d89e7b6d19335f606e788c0a37943c5b.jpg", rarity: "legendary", is_featured: true, description: "Um manto imponente que emana uma aura de autoridade e coragem." },
  { id: "mq_cloth_stealth", name: "Capa de Invisibilidade", category: "clothing", price_galeons: 10000, image_url: "https://i.pinimg.com/736x/21/2e/4d/212e4d898495f3209867938363784912.jpg", rarity: "legendary", is_featured: true, description: "Tecida com fios de seminviso, esta capa torna o usuário indetectável." },

  // POTIONS
  { id: "mq_potion_dragon", name: "Sangue de Dragão", category: "potion", price_galeons: 1500, image_url: "https://i.pinimg.com/736x/8f/7d/5a/8f7d5a5700810488663806954848912.jpg", rarity: "rare", is_featured: false, description: "Uma poção poderosa que amplifica a força vital e resistência mágica." },
  { id: "mq_potion_luck", name: "Felix Felicis", category: "potion", price_galeons: 4000, image_url: "https://i.pinimg.com/736x/9e/7b/d8/9e7bd89e7b6d19335f606e788c0a3794.jpg", rarity: "legendary", is_featured: true, description: "A Sorte Líquida. Por um tempo limitado, todas as suas ações serão bem-sucedidas." },
  { id: "mq_potion_truth", name: "Veritaserum", category: "potion", price_galeons: 2000, image_url: "https://i.pinimg.com/736x/d8/9e/7b/d89e7b6d19335f606e788c0a37943c5b.jpg", rarity: "rare", is_featured: false, description: "O mais poderoso soro da verdade conhecido no mundo bruxo." },
  ...
  { id: "mq_item_founder", name: "Emblema dos Fundadores", category: "accessory", price_galeons: 10000, image_url: "/vip_coroa.png", rarity: "legendary", is_featured: true, description: "O símbolo máximo de autoridade e tradição mágica." },
