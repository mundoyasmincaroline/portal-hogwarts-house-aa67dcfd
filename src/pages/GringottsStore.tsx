...
const MONSTER_QUALITY_ITEMS: StoreItem[] = [
  ...
  { id: "mq_wand_ebony", name: "Varinha de Ébano", category: "wand", price_galeons: 2500, image_url: "/items/monster_quality_wand_elder.png", rarity: "rare", is_featured: false, description: "Ébano é uma madeira preta e impressionante, com um brilho quase metálico." },
  { id: "mq_wand_holly", name: "Varinha de Azevinho", category: "wand", price_galeons: 1200, image_url: "/items/monster_quality_wand_elder.png", rarity: "uncommon", is_featured: false, description: "Uma das madeiras de varinha mais raras e protetoras." },
  ...
  { id: "mq_cloth_stealth", name: "Capa de Invisibilidade", category: "clothing", price_galeons: 10000, image_url: "/placeholder.svg", rarity: "legendary", is_featured: true, description: "Tecida com fios de seminviso, esta capa torna o usuário indetectável." },
  ...
  // ACCESSORIES
  { id: "mq_accessory_crown", name: "Coroa de Ravenclaw", category: "accessory", price_galeons: 4500, image_url: "/vip_coroa.png", rarity: "legendary", is_featured: true, description: "O diadema perdido de Rowena Ravenclaw. Dizem que concede sabedoria inigualável." },
  { id: "mq_item_snitch", name: "Pomo de Ouro de Vidro", category: "accessory", price_galeons: 3000, image_url: "/items/monster_quality_golden_snitch.png", rarity: "rare", is_featured: true, description: "Um artefato de luxo que captura a essência do voo e da vitória." },
