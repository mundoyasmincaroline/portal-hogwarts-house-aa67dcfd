...
export default function Register() {
  ...
  const [form, setForm] = useState({
    fullName: "", username: "", age: "", house: "" as House | "", photo: null as File | null,
  });
      ...
      <div className="glass rounded-2xl p-8 w-full max-w-lg z-20 animate-fade-in-up">
        ...
        {step === 1 && (
          <div className="space-y-4">
            ...
            <div>
              <label className="text-sm font-heading text-muted-foreground block mb-1">Foto (para validação)</label>
              <Input type="file" accept="image/*" onChange={(e) => setForm({ ...form, photo: e.target.files?.[0] || null })} className="bg-secondary/50" />
            </div>
        ...
        {step === 2 && (
          <div className="space-y-4">
            ...
            <div className="flex gap-3">
              ...
              <Button variant="magical" className="flex-1 font-heading" onClick={handleSubmit}>Enviar Matrícula</Button>
            </div>
          </div>
        )}
        ...
        {step === 3 && (
          <div className="text-center space-y-4 py-8">
            ...
            <p className="text-muted-foreground text-sm">
              Sua solicitação foi enviada para aprovação. Um administrador irá revisar sua ficha em breve.
            </p>
