...
export default function Terms() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground selection:bg-primary/30 selection:text-white">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-2 sm:px-6 py-12 md:py-20">
        <Button variant="ghost" onClick={() => navigate(-1)} className="mb-10 hover:bg-white/5 gap-2 group">
          <ChevronLeft size={20} className="group-hover:-translate-x-1 transition-transform" />
          Voltar
        </Button>

        <div className="glass rounded-2xl sm:rounded-[3rem] p-5 sm:p-8 md:p-16 border border-white/10 shadow-2xl backdrop-blur-xl">
          <div className="flex items-center gap-4 mb-8">
             <div className="w-14 h-14 rounded-2xl bg-primary/10 border border-primary/20 flex items-center justify-center text-primary">
               <Scale size={28} />
             </div>
             <div>
               <h1 className="font-heading text-2xl sm:text-4xl text-gold-gradient tracking-tight">Termos de Uso</h1>
