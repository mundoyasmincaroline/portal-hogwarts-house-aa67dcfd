...
export default function Profile() {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8 pb-10">
      ...
      <div className="flex gap-1 border-b border-white/5 mb-4 sm:mb-8 overflow-x-auto pb-2 scrollbar-hide whitespace-nowrap relative z-10 p-1 bg-card/40 backdrop-blur-md rounded-2xl mx-1 sm:mx-0 sticky top-16 md:top-4">
        {[
