...
export default function ChatRoom() {
  ...
  return (
    <div className="max-w-5xl mx-auto h-[calc(100dvh-160px)] md:h-[calc(100vh-120px)] flex flex-col glass rounded-[2.5rem] overflow-hidden border border-white/10 shadow-2xl relative">
